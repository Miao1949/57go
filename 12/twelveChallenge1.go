...
func calculateInvestment(principal int, rateAsPercentage float64, numberOfYears int) (valueAfterPeriod float64){
...
func main() {
	...
	valueAfterPeriod := calculateInvestment(principal, rateAsPercentage, numberOfYears)
